...
describe('when withdrawing funds', () => {
    ...
    it('then staking on second period should be ok to collect old rewards later', async () => {
        ...
        await advanceToFuture(periodDuration); //2nd period over
        ...
        await advanceToFuture(offset + 30); //3rd period active
